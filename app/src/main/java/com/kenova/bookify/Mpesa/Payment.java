...
public class Payment extends AppCompatActivity implements AuthListener, MpesaListener {
    ...
    public static final String SHARED_PREFERENCES = "com.kenova.bookify.Mpesa";
